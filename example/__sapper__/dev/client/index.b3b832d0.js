...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(figcaption, file, 42, 1, 474);
			attr_dev(figure, "class", "svelte-owv8pc");
			add_location(figure, file, 41, 0, 464);
			add_location(strong, file, 45, 3, 535);
			attr_dev(p, "class", "svelte-owv8pc");
			add_location(p, file, 45, 0, 532);
		},
		m: function mount(target, anchor) {
