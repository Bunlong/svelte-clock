...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "svelte-3gw1ax");
			add_location(h1, file, 40, 0, 477);
			attr_dev(div, "class", "clock-size svelte-3gw1ax");
			add_location(div, file, 44, 0, 490);
			add_location(figcaption, file, 49, 1, 544);
			attr_dev(figure, "class", "svelte-3gw1ax");
			add_location(figure, file, 48, 0, 534);
			add_location(strong, file, 52, 3, 605);
			attr_dev(p, "class", "svelte-3gw1ax");
			add_location(p, file, 52, 0, 602);
		},
		m: function mount(target, anchor) {
