...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "svelte-1h5wc1t");
			add_location(h1, file, 40, 0, 475);
			attr_dev(div, "class", "clock-size svelte-1h5wc1t");
			add_location(div, file, 44, 0, 488);
			add_location(figcaption, file, 49, 1, 542);
			attr_dev(figure, "class", "svelte-1h5wc1t");
			add_location(figure, file, 48, 0, 532);
			add_location(strong, file, 52, 3, 603);
			attr_dev(p, "class", "svelte-1h5wc1t");
			add_location(p, file, 52, 0, 600);
		},
		m: function mount(target, anchor) {
