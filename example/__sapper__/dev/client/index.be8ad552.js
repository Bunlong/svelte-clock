...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "svelte-z0zzk2");
			add_location(h1, file, 41, 0, 491);
			attr_dev(div, "class", "clock-size svelte-z0zzk2");
			add_location(div, file, 45, 0, 504);
			add_location(figcaption, file, 50, 1, 558);
			attr_dev(figure, "class", "svelte-z0zzk2");
			add_location(figure, file, 49, 0, 548);
			add_location(strong, file, 53, 3, 619);
			attr_dev(p, "class", "svelte-z0zzk2");
			add_location(p, file, 53, 0, 616);
		},
		m: function mount(target, anchor) {
